...
- **Gates non contournables** : la QA, le déploiement et les vérifications finales sont modélisés comme des étapes du runtime plutôt que comme de simples instructions.
